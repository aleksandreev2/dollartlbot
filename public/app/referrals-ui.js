(() => {
  ...
  const L = {
    ...
    ru:{title:'Пригласить друзей',sub:'До +3 дополнительных заявок',hero:'Пригласите друга в Dollar TL',copy:'Ваша ссылка сначала открывает бота Dollar TL. Из бота друг вступает в наш канал и остаётся там 7 дней. После проверки вы получаете +1 дополнительную заявку. Максимум — +3.',yourLink:'Ваша реферальная ссылка',copyBtn:'Копировать',share:'Поделиться',copied:'Ссылка скопирована',invited:'Приглашено',pending:'Ожидают',available:'Доступно',rewards:'Реферальные бонусы',progress:'Прогресс 7 дней',friend:'Друг вступил',day:'День',daysLeft:'дн. осталось',bonus:'Реферальный бонус',back:'Назад',empty:'Активных приглашений пока нет. Отправьте ссылку первому другу.'},
    es:{title:'Invita y gana',sub:'Hasta +3 solicitudes extra',hero:'Invita a un amigo a Dollar TL',copy:'Tu enlace abre primero el bot de Dollar TL. Desde allí, tu amigo entra en nuestro canal y permanece 7 días. Tras la verificación recibes +1 solicitud extra. Máximo: +3.',yourLink:'Tu enlace de referido',copyBtn:'Copiar',share:'Compartir',copied:'Enlace copiado',invited:'Invitados',pending:'Pendientes',available:'Disponibles',rewards:'Bonos por referidos',progress:'Progreso de 7 días',friend:'Amigo unido',day:'Día',daysLeft:'días restantes',bonus:'Bono por referidos',back:'Atrás',empty:'Todavía no hay referidos activos. Comparte tu enlace con tu primer amigo.'},
    fil:{title:'Mag-imbita ng Kaibigan',sub:'Hanggang +3 dagdag na kahilingan',hero:'Mag-imbita ng kaibigan sa Dollar TL',copy:'Bubuksan muna ng link mo ang Dollar TL bot. Mula roon, sasali ang kaibigan mo sa channel at mananatili nang 7 araw. Kapag napatunayan, makakakuha ka ng +1 dagdag na kahilingan. Maximum: +3.',yourLink:'Referral link mo',copyBtn:'Kopyahin',share:'Ibahagi',copied:'Nakopya ang link',invited:'Naimbitahan',pending:'Naghihintay',available:'Magagamit',rewards:'Mga referral bonus',progress:'7-araw na progreso',friend:'Sumali ang kaibigan',day:'Araw',daysLeft:'araw pa',bonus:'Referral bonus',back:'Bumalik',empty:'Wala pang aktibong referral. Ibahagi ang link mo sa unang kaibigan.'},
    hi:{title:'दोस्त आमंत्रित करें',sub:'अधिकतम +3 अतिरिक्त अनुरोध',hero:'दोस्त को Dollar TL में बुलाएँ',copy:'आपका लिंक पहले Dollar TL बॉट खोलेगा। वहाँ से आपका दोस्त हमारे चैनल में जुड़ता है और 7 दिन सदस्य रहता है। सत्यापन के बाद आपको +1 अतिरिक्त उपन्यास अनुरोध मिलता है। अधिकतम: +3।',yourLink:'आपका रेफ़रल लिंक',copyBtn:'कॉपी करें',share:'शेयर करें',copied:'लिंक कॉपी हो गया',invited:'आमंत्रित',pending:'लंबित',available:'उपलब्ध',rewards:'रेफ़रल बोनस',progress:'7 दिन की प्रगति',friend:'दोस्त जुड़ा',day:'दिन',daysLeft:'दिन बाकी',bonus:'रेफ़रल बोनस',back:'वापस',empty:'अभी कोई सक्रिय रेफ़रल नहीं है। अपना लिंक पहले दोस्त के साथ साझा करें।'},
    pt:{title:'Convide amigos',sub:'Até +3 pedidos extras',hero:'Convide um amigo para o Dollar TL',copy:'Seu link abre primeiro o bot do Dollar TL. A partir dele, seu amigo entra no nosso canal e permanece por 7 dias. Após a verificação, você recebe +1 pedido extra. Máximo: +3.',yourLink:'Seu link de indicação',copyBtn:'Copiar',share:'Compartilhar',copied:'Link copiado',invited:'Convidados',pending:'Pendentes',available:'Disponíveis',rewards:'Bônus de indicação',progress:'Progresso de 7 dias',friend:'Amigo entrou',day:'Dia',daysLeft:'dias restantes',bonus:'Bônus de indicação',back:'Voltar',empty:'Ainda não há indicações ativas. Compartilhe seu link com o primeiro amigo.'},
    id:{title:'Undang Teman',sub:'Hingga +3 permintaan tambahan',hero:'Undang teman ke Dollar TL',copy:'Tautanmu akan membuka bot Dollar TL terlebih dahulu. Dari sana, temanmu bergabung ke channel dan tetap menjadi anggota selama 7 hari. Setelah diverifikasi, kamu mendapat +1 permintaan tambahan. Maksimum: +3.',yourLink:'Tautan referralmu',copyBtn:'Salin',share:'Bagikan',copied:'Tautan disalin',invited:'Diundang',pending:'Menunggu',available:'Tersedia',rewards:'Bonus referral',progress:'Progres 7 hari',friend:'Teman bergabung',day:'Hari',daysLeft:'hari lagi',bonus:'Bonus referral',back:'Kembali',empty:'Belum ada referral aktif. Bagikan tautanmu ke teman pertama.'},
    vi:{title:'Mời bạn bè',sub:'Tối đa +3 lượt yêu cầu thêm',hero:'Mời một người bạn vào Dollar TL',copy:'Liên kết của bạn sẽ mở bot Dollar TL trước. Từ đó, bạn của bạn tham gia kênh và ở lại 7 ngày. Sau khi xác minh, bạn nhận +1 lượt yêu cầu tiểu thuyết. Tối đa: +3.',yourLink:'Liên kết giới thiệu của bạn',copyBtn:'Sao chép',share:'Chia sẻ',copied:'Đã sao chép liên kết',invited:'Đã mời',pending:'Đang chờ',available:'Khả dụng',rewards:'Thưởng giới thiệu',progress:'Tiến độ 7 ngày',friend:'Bạn đã tham gia',day:'Ngày',daysLeft:'ngày còn lại',bonus:'Thưởng giới thiệu',back:'Quay lại',empty:'Chưa có lượt giới thiệu đang hoạt động. Hãy chia sẻ liên kết với người bạn đầu tiên.'},
    fr:{title:'Inviter des amis',sub:'Jusqu’à +3 demandes bonus',hero:'Invitez un ami sur Dollar TL',copy:'Votre lien ouvre d’abord le bot Dollar TL. Votre ami rejoint ensuite notre canal et y reste 7 jours. Après vérification, vous recevez +1 demande de roman. Maximum : +3.',yourLink:'Votre lien de parrainage',copyBtn:'Copier',share:'Partager',copied:'Lien copié',invited:'Invités',pending:'En attente',available:'Disponibles',rewards:'Bonus de parrainage',progress:'Progression sur 7 jours',friend:'Ami inscrit',day:'Jour',daysLeft:'jours restants',bonus:'Bonus de parrainage',back:'Retour',empty:'Aucun parrainage actif pour le moment. Partagez votre lien avec votre premier ami.'},
    de:{title:'Freunde einladen',sub:'Bis zu +3 zusätzliche Anfragen',hero:'Lade einen Freund zu Dollar TL ein',copy:'Dein Link öffnet zuerst den Dollar TL Bot. Von dort tritt dein Freund unserem Kanal bei und bleibt 7 Tage Mitglied. Nach der Prüfung erhältst du +1 zusätzliche Roman-Anfrage. Maximum: +3.',yourLink:'Dein Empfehlungslink',copyBtn:'Kopieren',share:'Teilen',copied:'Link kopiert',invited:'Eingeladen',pending:'Ausstehend',available:'Verfügbar',rewards:'Empfehlungsbonus',progress:'7-Tage-Fortschritt',friend:'Freund beigetreten',day:'Tag',daysLeft:'Tage übrig',bonus:'Empfehlungsbonus',back:'Zurück',empty:'Noch keine aktiven Empfehlungen. Teile deinen Link mit deinem ersten Freund.'},
  };
  ...
  async function installBonusStrip(root=document) {
    ...
    strip.innerHTML = `<div class="referral-bonus-copy"><div class="referral-bonus-label">${esc(tr('bonus'))}</div><div class="referral-bonus-caption">+${bonus} / ${info.max_bonus}</div></div><div class="referral-quota-numbers"><span class="referral-quota-base">${info.quota.base_limit}</span><span class="referral-quota-new">${info.quota.effective_limit}</span></div>`;
  ...
  function renderPage(root, info) {
    ...
    const bonus = Number(info.quota?.bonus || 0);
    const baseLimit = Number(info.quota?.base_limit || 0);
    const effectiveLimit = Number(info.quota?.effective_limit || baseLimit);
    ...
    const quotaNumbers = bonus > 0
      ? `<span class="referral-quota-base">${baseLimit}</span><span class="referral-quota-new">${effectiveLimit}</span>`
      : `<span class="referral-quota-current">${baseLimit}</span>`;

    root.innerHTML = `<section class="page referral-page" data-referral-page data-ref-bonus="${bonus}">
      ...
      <section class="referral-quota-card ${bonus > 0 ? 'has-bonus' : 'no-bonus'}">
        <div class="referral-quota-copy"><span>${esc(tr('bonus'))}</span><strong>${bonus > 0 ? `+${bonus}` : '0'} / ${info.max_bonus}</strong></div>
        <div class="referral-quota-numbers referral-page-quota">${quotaNumbers}</div>
      </section>
  ...
  function updatePage(info) {
    ...
    if (!page) return;
    const nextBonus = Number(info.quota?.bonus || 0);
    const currentBonus = Number(page.dataset.refBonus || 0);
    if (nextBonus !== currentBonus) {
      const root = document.getElementById('viewRoot');
      if (root) renderPage(root, info);
      return;
    }
    const pending = Array.isArray(info.pending) ? info.pending : [];
    const qualified = Array.isArray(info.qualified) ? info.qualified : [];
