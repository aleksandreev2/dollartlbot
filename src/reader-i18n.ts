...
function c(
  ...
  download: string, thankYou: string, preparing: string, quotaReached: string,
  ...
  return { library,latestUpdates,openTitle,rating,rateTitle,download,thankYou,preparing,quotaReached,quotaStatus,boostyUnlimited,termsTitle,termsBody,termsAccept,filesSent };
}
