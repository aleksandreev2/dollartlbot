...
const COPY: Record<string, FollowCopy> = {
  ...
  ur:{accepted:'آپ کے follow کیے گئے عنوان کو قبول کر لیا گیا',started:'آپ کے follow کیے گئے عنوان کا ترجمہ شروع ہو گیا',completed:'Follow کیا گیا ترجمہ مکمل ہو گیا',progress:'Follow کیے گئے ترجمے میں پیش رفت ہوئی',acceptedBody:'Dollar TL نے اس عنوان کو ترجمے کے لیے قبول کر لیا ہے۔',startedBody:'Dollar TL نے اس عنوان کا ترجمہ شروع کر دیا ہے۔',completedBody:'ترجمہ مکمل نشان زد کر دیا گیا ہے۔',progressLabel:'پیش رفت',queue:'قطار میں پوزیشن',since:'پچھلی اپ ڈیٹ سے'},
};
