...
const layers=layerSpecs.map(([path,name])=>{const obj=evalExportObject(path,name);exactLocales(obj,`${path}/${name}`);if(name==='accessGateTranslations')sameKeys(obj,`${path}/${name}`);return obj;});
