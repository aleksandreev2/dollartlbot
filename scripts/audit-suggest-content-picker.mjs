...
need(index,'/app/suggest-content-activation.js?v=20260810-content2','suggest activation asset');
...
const activationIndex=index.indexOf('/app/suggest-content-activation.js?v=20260810-content2');
const bootstrap=index.indexOf('/app/app.js?v=20260810-app1');
if(view<0||picker<0||activationIndex<0||bootstrap<0||picker<=view||activationIndex<=picker||activationIndex>=bootstrap)throw new Error('Suggest picker and fallback activation must load after the canonical Suggest view and before app bootstrap');
...
need(wrangler,'?build=20260810-cache-rescue1','versioned Mini App URL');

console.log('Suggest content picker audit passed: expanded content picker, fallback activation, fresh Telegram document URL, and no-store Mini App shell caching.');
